...
| v2 | TBD | LightGBM regressor, CV R²=0.9763 | Target/freq encoding, date features, interactions, tuned params |
...
- Public LB score を確認して leakage の有無を判断
- leakage がある場合は fold-internal target encoding に切り替え
